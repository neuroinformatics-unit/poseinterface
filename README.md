...
- Develop a general-purpose **Python framework**, provided through the
  `poseinterface` Python package, for running pose estimation
  and point-tracking tools on *PoseMark*, and for benchmarking their outputs
  using standardised evaluation metrics.
